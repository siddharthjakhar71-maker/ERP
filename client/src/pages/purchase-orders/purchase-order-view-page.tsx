...
export const PurchaseOrderViewPage = () => {
  ...
  return (
    <PurchaseOrderPageLayout
      ...
      actions={purchaseOrder.data ? <Link to="/purchase-orders/$purchaseOrderId/edit" params={{ purchaseOrderId }} className={buttonVariants()}><Pencil className="mr-2 h-4 w-4" />Edit purchase order</Link> : null}
    >
